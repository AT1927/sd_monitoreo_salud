...
--
-- Host: localhost    Database: monitoreo_salud
-- ------------------------------------------------------
...
CREATE TABLE `datos_salud` (
  ...
  CONSTRAINT `datos_salud_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`)
...
-- Dump completed on 2024-05-27 18:28:29
